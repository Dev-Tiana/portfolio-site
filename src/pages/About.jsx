...
const About = () => {
  return (
    <div className='pb-10 mb-10'>
      ...
      >
        <h1 className='font-[Sora] font-bold text-[48px] text-[#42446E] pr-[8%] py-6'>About Me</h1>
        <p className='font-[Sora] font-normal text-[#666666] text-[16px]'>
      ...
      >
        <h1 className='font-[Sora] font-bold text-[48px] text-[#42446E] px-[8%] py-6'>Work Experience</h1>
        <Aboutcard />
      </motion.div>
      ...
      <motion.div
        ...
        className=''
      >
        <h1 className='font-[Sora] font-bold text-[48px] text-[#42446E] px-[8%]'>Education</h1>
        <Aboutcard2 />
      </motion.div>
