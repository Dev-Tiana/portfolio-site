  ...
  return (
    <div className='flex flex-col gap-4 px-[7%] py-10 my-15'>
        ...
        <div className='grid grid-cols-3 md:grid-cols-6 gap-2 '>
            <div>
              <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word1}</h1>
              <img className='w-[80px] h-[80px] my-6' src={image1} alt="" />
            </div>
            <div>
              <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word2}</h1>
               <img className='w-[80px] h-[80px] my-6' src={image2} alt="" />
            </div>
            <div>
               <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word3}</h1>
              <img className='w-[80px] h-[80px] my-6' src={image3} alt="" />
            </div>
            
            <div>
              <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word4}</h1>
              <img className='w-[80px] h-[80px] my-6' src={image4} alt="" />
            </div>
            <div>
                <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word5}</h1>
               <img className='w-[80px] h-[80px] my-6' src={image5} alt="" />
            </div>
             <div>
              <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word6}</h1>
              <img className='w-[80px] h-[80px] my-6 md:ml-6' src={image6} alt="" />
             </div>
            <div>
                <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word7}</h1>
               <img className='w-[80px] h-[80px] my-6' src={image7} alt="" />
            </div>
             <div>
                <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word8}</h1>
              <img className='w-[80px] h-[80px] my-6' src={image8} alt="" />
             </div>
             <div>
                <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word9}</h1>
              <img className='w-[80px] h-[80px] my-6' src={image9} alt="" />
             </div>
             <div>
                <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[18px]'>{word10}</h1>
              <img className='w-[80px] h-[80px] my-6' src={image10} alt="" />
             </div>
             <div>
                <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word11}</h1>
              <img className='w-[80px] h-[80px] my-6' src={image11} alt="" />
             </div>
             <div>
                <h1 className='font-normal  font-[Sora] text-[#CCCCCC] text-[15px]'>{word12}</h1>
